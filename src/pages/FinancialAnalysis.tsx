    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 gap-4">
        ...
        <div className="flex gap-2">
          ...
          <Button size="sm" className="bg-indigo-600">申请专业版分析报告</Button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {[
          ...
          { label: '纳税评级', value: 'A级', trend: '连续3年', isUp: true, icon: Activity, color: 'text-indigo-600' },
        ].map((kpi, idx) => (
        ...
        <Card className="p-6 lg:col-span-2">
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex gap-2">
              ...
              <Badge variant="outline" className="text-slate-400 cursor-pointer border-transparent">季度</Badge>
            </div>
          </div>
          ...
          <div className="relative h-64 w-full">
            ...
            <svg viewBox="0 0 1000 300" className="w-full h-full">
              ...
              {/* Points */}
              <circle cx="50" cy="250" r="6" fill="white" stroke="#4f46e5" strokeWidth="3" />
              <circle cx="250" cy="200" r="6" fill="white" stroke="#4f46e5" strokeWidth="3" />
              <circle cx="450" cy="150" r="6" fill="white" stroke="#4f46e5" strokeWidth="3" />
              <circle cx="650" cy="100" r="6" fill="white" stroke="#4f46e5" strokeWidth="3" />
              <circle cx="850" cy="50" r="6" fill="white" stroke="#4f46e5" strokeWidth="3" />
          ...
          <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="p-3 bg-slate-50 rounded-lg">
              <p className="text-[10px] text-slate-400 mb-1 uppercase tracking-wider">复合增长率</p>
              <p className="font-bold text-slate-900">18.4%</p>
            </div>
            <div className="p-3 bg-slate-50 rounded-lg">
              <p className="text-[10px] text-slate-400 mb-1 uppercase tracking-wider">行业分位</p>
              <p className="font-bold text-indigo-600">前 1%</p>
            </div>
            <div className="p-3 bg-slate-50 rounded-lg">
              <p className="text-[10px] text-slate-400 mb-1 uppercase tracking-wider">现金流状态</p>
              <p className="font-bold text-emerald-600">极充沛</p>
            </div>
            <div className="p-3 bg-slate-50 rounded-lg">
              <p className="text-[10px] text-slate-400 mb-1 uppercase tracking-wider">速动比率</p>
            ...
            <div className="flex items-center justify-center py-6">
              <div className="relative w-32 h-32 flex items-center justify-center">
                <svg className="w-full h-full transform -rotate-90">
                  ...
                  <circle cx="64" cy="64" r="58" stroke="#4f46e5" strokeWidth="8" fill="none" strokeDasharray="364.4" strokeDashoffset="36.4" />
                </svg>
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <span className="text-3xl font-bold text-indigo-600">92</span>
                  <span className="text-[10px] text-slate-400 font-bold uppercase">极好</span>
                </div>
              </div>
            </div>
          ...
          <Card className="p-6 bg-slate-900 text-white border-none">
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex gap-2">
                ...
                <span className="text-slate-300">经营性现金流连续 12 个季度为正</span>
              </li>
              <li className="flex gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-indigo-400 mt-1.5 flex-shrink-0"></div>
                <span className="text-slate-300">主要子公司业绩承诺均已达成</span>
              </li>
              <li className="flex gap-2">
                <div className="w-1.5 h-1.5 rounded-full bg-orange-400 mt-1.5 flex-shrink-0"></div>
                <span className="text-slate-300">注意其在云计算领域的研发投入占比变化</span>
              </li>
            </ul>
            <Button className="w-full mt-6 bg-indigo-600 hover:bg-indigo-700">咨询分析师</Button>
          </Card>
        </div>
      </div>
    </div>
